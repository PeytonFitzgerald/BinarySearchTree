...
#print(new_tree.pre_order_traversal())
#print(new_tree.post_order_traversal())
new_tree.remove(32)
print(new_tree.in_order_traversal())
...
for x in new_tree.pre_order_traversal():
    print(x)
new_tree.remove_first()
print('\n')
print(new_tree.root.val)
print(new_tree.root.left.val)
...
test_values = [Student(15, "Root"), Student(0, "Root->L"), Student(-5, "Root->L->L"),
                       ...
                       Student(17, "Root->R->L")]
new_tree = BST(test_values)
# Starting Tree:
#                     15
#                 0       20
#              -5   5  17    25
#
print(new_tree.root.val.grade)
print(new_tree.root.right.val.grade)
print(new_tree.root.right.right.val.grade)
...
print(new_tree.root.val)
print(new_tree.root.left.val)
print(new_tree.root.left.left.val)
print(new_tree.root.left.right.val)
print('\n')
# Test 4
# delete 5
print(new_tree.remove(Student(5, "Root->L->R")))
print(new_tree.root.val)
print(new_tree.root.left.val)
print(new_tree.root.left.left.val)
print(new_tree.root.left.right.val)
